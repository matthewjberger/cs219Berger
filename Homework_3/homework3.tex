		...
		\hfil
			\begin{tabular}{|c l l|}
				\hline
		 		\multicolumn{1}{|c|}{Line Number} &  \multicolumn{1}{|c|}{Instruction}  & \multicolumn{1}{|c|}{Comments} \\
				\hline
				00 & LDA14 & // Load the value from location 14 into the Accumulator \\
				01 & SUB15 & // Substract the value at location 15 from the Accumulator \\
				02 & STA14 & // Store the value of the Accumulator at location 14 \\
				03 & LDA12 & // Load the value from location 12 into the Accumulator \\				
				04 & OUT12 & // Output the value from location 12 \\
				05 & MUL13 & // Multiply the value in the Accumulator by the value at location 13 \\
				06 & STA12 & // Store the value from the Accumulator at location 12 \\	
				07 & LDA14 & // Load the value from location 14 into the Accumulator \\	
				08 & SKP4  & // Skip the next instruction if the value in the Accumulator is less than or equal to 0 \\	
				09 & JMP0  & // Jump to address 00 \\	
				10 & STP   & // HALT \\													
				\hline
			\end{tabular} 
		\end{table}
	...
	\item[3.3)]	Write a program that uses an INP instruction. If the number that you INPut is positive or zero, have your program OUTput the number 1. If the number that you INPut is negative, have the program OUTput the number zero.
		...
		\hfil
			\begin{tabular}{|c c c c|}
				\hline
		 		\multicolumn{1}{|c|}{Address} &  \multicolumn{1}{|c|}{Instruction} & \multicolumn{1}{|c|}{Argument} & \multicolumn{1}{|c|}{Comments} \\
				\hline
